...
class Orchestrator {
    ...
    _initialMessages({ cfg, view, selection, userText, attachments }) {
        const parts = [
            ...
            '3. USE images for complex visuals: If the element has complex graphical detail that cannot be composed from shapes (e.g. a company logo, a photorealistic icon, a floor plan photo), use html-image with a URL or generated image path.',
            '4. PLACEHOLDER as last resort: If no image is available and the element cannot be built from shapes, place a svg-ext-rect as placeholder with a svg-ext-text label inside describing what the element should be (e.g. "LOGO", "SITE PLAN"). Use fill="#333" stroke="#555" for the rect and white text.',
            '',
